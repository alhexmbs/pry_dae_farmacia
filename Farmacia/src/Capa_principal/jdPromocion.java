...
public class jdPromocion extends javax.swing.JDialog {
    ...
    private void btnBuscar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscar1ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al buscar la promoción: " + e.getMessage());
        }
        ...
        try {
            if (btnSave.getText().equals("NUEVO")) {
                ...
                if (txtId2.getText().isEmpty() || txtDescuento.getText().isEmpty() || jcFechaInicio.getDate() == null || jcFechaFin.getDate() == null) {
                    ...
                    limpiar();
                    listar("General");
                    JOptionPane.showMessageDialog(this, "Promoción gardada correctamente");
                }
    ...
    private void btnModificaarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificaarActionPerformed
        if (txtId2.getText().isEmpty() || txtDescuento.getText().isEmpty() || jcFechaInicio.getDate() == null || jcFechaFin.getDate() == null) {
            ...
            try {
                int confirmacion = JOptionPane.showConfirmDialog(this, "¿Desea modificar esta promoción?");
                ...
                JOptionPane.showMessageDialog(this, "Error al modificar la promoción: " + e.getMessage());
            }
        }
        ...
        try {
            if (txtId2.getText().isEmpty()) {
                ...
                if (confirmacion == JOptionPane.YES_OPTION) {
                    ...
                    limpiar();
                    listar("General");
                    JOptionPane.showMessageDialog(this, "Promoción eliminada correctamente");
                }
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error al eliminar la promoción: " + e.getMessage());
        }
