 ...
 * @author Katia
 */
public class jdR_Katia_PerdidasProductosCaducados extends javax.swing.JDialog {

    public jdR_Katia_PerdidasProductosCaducados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();                
